...
const mockLocalStorage = (() => {
    let store = {};
    return {
        getItem: jest.fn(key => store[key] || "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImxAZ21haWwuY29tIiwiaWQiOjksInJvbGUiOiJvd25lciJ9.eRndaP1GVyZ4rWEU8TO3-RvDk6IKHTp7SBEWBEFWEkk"),
    ...
    test("renders owner dashboard with correct titles", async () => {
        ...
        axios.get.mockImplementation((url) => {
            if (url === "http://localhost:8000/api/library/getlib") {
                return Promise.resolve({ data: { library: { id: 1, name: "Test Library" } } });
            }
